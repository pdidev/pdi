...
void TiXmlBase::PutString( const TIXML_STRING& str, TIXML_STRING* outString )
{
	...
	while( i<(int)str.length() )
	{
		...
		/* Bruno (10/04): comment the following lines 
		   to avoid  parser to change '&', '<', .... into entities 
		   (&#x0A; ...). Ouptut text is easier to read. 
		*/
// 		else if ( c == '&' )
// 		{
...
// 		}
 		else if ( c < 32 )
 		{
		  ...
		  /* Bruno  / J-D  07/07: To avoid changing carriage return into entity &#x0A;
		   */
		  if (c== '\n')  
