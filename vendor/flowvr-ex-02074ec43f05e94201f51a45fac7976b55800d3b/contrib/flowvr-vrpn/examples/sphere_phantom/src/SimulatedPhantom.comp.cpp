...
#include "sphere_phantom/components/SimulatedPhantom.comp.h"

using namespace flowvr;
using namespace flowvr::app;
using namespace flowvrvrpn;

void SimulatedPhantom::execute() {
    
    Component* vrpn2flowvr = addObject(MetaModuleFlowvrRunSSHSingleton<Modulevrpn2flowvr>("vrpn2flowvr", CmdLine("simulateddevice phantom.xml")));
