...
void Idle() {
    ...
    if (In1->isConnected()) {
        ...
        for (ftl::ChunkIterator it = ftl::chunkBegin(MIn1); it!=ftl::chunkEnd(MIn1); it++) {
            ...
            if ((c->type & 0x0F) == ftl::ChunkEvent::SLIDER) {
                const ftl::ChunkEventSlider* slider = (const ftl::ChunkEventSlider*) c;
                int evenement = static_cast<int>(slider->key);
                switch(evenement) {
                case 0:
                    if (slider->val != 0) {
                        valide[0] = 1;
                ...
                case 3:
                    ...
                    break;
                case 4:
                    psi_active = slider->val;
                    break;
                case 5:
                    theta_active = slider->val;
                    break;
                case 6:
                    break;
                }
    ...
    /*    theta += 0.001*theta_active;    
          psi += 0.001*psi_active;    */
