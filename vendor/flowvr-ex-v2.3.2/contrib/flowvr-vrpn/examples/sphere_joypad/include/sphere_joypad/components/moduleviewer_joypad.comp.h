...
#ifndef _MODULEVIEWERJOYPAD_H_
#define _MODULEVIEWERJOYPAD_H_

using namespace flowvr::app;

namespace sphere_joypad 
{
  class ModuleViewer_joypad : public Module 
    {
      public :
	ModuleViewer_joypad(const std::string& id_) : Module(id_)
	{
      ...
      virtual Component* create() const { return new ModuleViewer_joypad(getId());
      };
    };
};
#endif 
