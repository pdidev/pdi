 ...
 *                                                                 *
 ******************************************************************/
#ifndef PORTOUTNODE_H_
#define PORTOUTNODE_H_

#include "GNode.h"

#include <string>

class PortOutNode : public GNode {
public:
	PortOutNode(float x, float y, float z, float width, float height, std::string label, int r=173, int g=218, int b=230, int o_r=0, int o_g=0, int o_b=0) :
