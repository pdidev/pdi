...
(
  ...
  export SION_BUFFERSIZE=-1
  echo "on rank 0 starting Test with SION_BUFFERSIZE=$SION_BUFFERSIZE" > stdout.log
  echo "on rank 0 starting Test with SION_BUFFERSIZE=$SION_BUFFERSIZE" > stderr.log
