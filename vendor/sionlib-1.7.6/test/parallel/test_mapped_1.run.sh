...
#  echo "on rank 0: starting Test with SION_COLLSIZE=$SION_COLLSIZE" > stdout.log
#  echo "on rank 0: starting Test with SION_COLLSIZE=$SION_COLLSIZE" > stderr.log
...
#  export SION_COLLSIZE=4
  ...
  export SION_DEBUG=test_siondump
