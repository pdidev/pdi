...
#define CHUNKSIZE 100
    ...
    sid = sion_paropen_mpi("testB.out", "bw,sionfwd", &numfiles, MPI_COMM_WORLD, &lcomm, &chunksize, &fsblksize, &globalrank, &fp, &newfname);
    if(sid>=0) {
...
#define CHUNKSIZE 100
    ...
    sid = sion_paropen_mpi("testB.out", "br,sionfwd", &numfiles, MPI_COMM_WORLD, &lcomm, &chunksize, &fsblksize, &globalrank, &fp, &newfname);
