...
(
  ...
  ${SIONDUMP} -a -l test_${TESTNAME}.sion 1> stdoutdump.log 2> stderrdump.log
  grep 'siondump:' stdoutdump.log | grep -v 'endianness' | grep -v 'SIONlib version' >> stdout.log
  grep 'Task ' stdoutdump.log >> stdout.log
