...
class Catalyst_plugin_structured_ghost
{
	...
	: m_ctx{ctx}, m_ghost_tree(tree), m_parent_tree(parent_tree), m_vtk_ghost_type{1,0}
	{
	...
	void get_dimension( conduit_node * parent_node, std::string & path_to_dims, std::string & PC_to_dataname, std::string data_type, std::string &data_type_name) {
