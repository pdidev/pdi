...
For example, release 1.1.0 can be downloaded from
https://gitlab.maisondelasimulation.fr/pdidev/pdi/-/archive/1.1.0/pdi-1.1.0.tar.bz2
...
For example, release 1.1.0 can be installed by following these instructions (but
