...
For example, release 1.3.0 can be downloaded from
https://gitlab.maisondelasimulation.fr/pdidev/pdi/-/archive/1.3.0/pdi-1.3.0.tar.bz2
...
For example, release 1.3.0 can be installed by following these instructions (but
look for the latest release at
https://gitlab.maisondelasimulation.fr/pdidev/pdi/-/releases ):

```bash
wget https://gitlab.maisondelasimulation.fr/pdidev/pdi/-/archive/1.3.0/pdi-1.3.0.tar.bz2
tar -xjf pdi-1.3.0.tar.bz2
mkdir pdi-1.3.0/build
cd pdi-1.3.0/build
