...
For example, release 1.2.2 can be downloaded from
https://gitlab.maisondelasimulation.fr/pdidev/pdi/-/archive/1.2.2/pdi-1.2.2.tar.bz2
...
For example, release 1.2.2 can be installed by following these instructions (but
