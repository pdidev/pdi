...
For example, release 0.6.5 can be downloaded from
https://gitlab.maisondelasimulation.fr/pdidev/pdi/-/archive/0.6.5/pdi-0.6.5.tar.bz2
...
For example, release 0.6.5 can be installed by following these instructions (but
look for the latest release at
https://gitlab.maisondelasimulation.fr/pdidev/pdi/tags):

```bash
wget https://gitlab.maisondelasimulation.fr/pdidev/pdi/-/archive/0.6.5/pdi-0.6.5.tar.bz2
tar -xjf pdi-0.6.5.tar.bz2
mkdir pdi-0.6.5/build
cd pdi-0.6.5/build
