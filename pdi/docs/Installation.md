...
For example, release 1.0.1 can be downloaded from
https://gitlab.maisondelasimulation.fr/pdidev/pdi/-/archive/1.0.1/pdi-1.0.1.tar.bz2
...
For example, release 1.0.1 can be installed by following these instructions (but
