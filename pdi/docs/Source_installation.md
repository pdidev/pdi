...
For example, release 1.9.1 can be downloaded from
https://github.com/pdidev/pdi/archive/refs/tags/1.9.1.tar.gz
...
For example, release 1.9.1 can be installed by following these instructions (but
look for the latest release at
https://github.com/pdidev/pdi/releases ):

```bash
wget https://github.com/pdidev/pdi/archive/refs/tags/1.9.1.tar.gz
tar -xjf 1.9.1.tar.bz2
mkdir 1.9.1/build
cd 1.9.1/build
