...
{
	PDI::Paraconf_wrapper fw;
	Global_context global_ctx{PC_parse_string("types: {member_type: {type: int, +attr: test_member}, record_type: {type: struct, members: "
...
{
	PDI::Paraconf_wrapper fw;
	Global_context global_ctx{PC_parse_string("data: {record_data: {type: struct, members: [first_member: {type: int, +attr: test_member}, "
...
TEST(DataAttrTest, array_in_map_attr)
{
	PDI::Paraconf_wrapper fw;
	Global_context global_ctx{
		PC_parse_string("data: {value: int, attr_array: {type: array, subtype: int, size: 10, +attr: {key: [$value, $value+1]} } }")
	};
	int value = 42;
